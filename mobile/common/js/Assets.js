(function () {
    ...
    Assets.prototype = {
        ...
        generateAssetsLayout: function (asset) {
            return "<h3 class='assetName'><p>" + asset.Asset + "</p><span class='farmQty'>" + asset.CurrentQuantity + "</span> \
                            <button data-role='none' data-assetname='" + asset.Asset + "' data-curval='" + asset.CurrentQuantity + "' data-assetid='" + asset.AssetId + "'> \
                    </button></h3>";
        },
        ...
        loadAssets: function () {
            ...
            $.ajax({
                ...
                success: function (r, textStatus, jqXHR) {
                    ...
                    for (i = 0; i < r.length; i++) {
                        that.$assetsContainer.append(that.generateAssetsLayout(r[i]));
                    }

                    that.$assetsContainer.append("<a href='#' id='btnAddNewAsset'>New Asset</a><a href='#' id='btnSubmitNewAsset'>Custom Asset</a>");
