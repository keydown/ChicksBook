(function () {
    ...
    Tasks.prototype = {
        ...
        generateTaskCode: function (task, className) {
            return "<li class='item task " + className + "'><h2 class='title'>" + task.Name + "</h2><div class='body'><p>" +
                task.Description + "</p><span hidden>" + task.TaskId + "</span></div></li>";
        },
            ...
            this.$tasksList.on("click", "li", function () {
                ...
                if (taskID == 9) {
                    if ($(this).hasClass(that.compTaskClass)) {
                        $("#modalContent").append("<div class='buttons modalButtonsHolder'><a class='button primary nearby' href='#' id='showNearbyVets'>Show Nearby Vets</a><a href='#' id='cancelModal'>Cancel</a></div>");
                    }
                    else {
                        $("#modalContent").append("<div class='buttons modalButtonsHolder'><a class='button primary nearby' href='#' id='showNearbyVets'>Show Nearby Vets</a><a href='#' class='tsk' data-taskid='" + taskID + "'>Mark As Done</a><a href='#' id='cancelModal'>Cancel</a></div>");
                    }
                }
                else if (taskID == 11) {
                    if ($(this).hasClass(that.compTaskClass)) {
                        $("#modalContent").append("<div class='buttons modalButtonsHolder'><a class='button primary nearby' href='#' id='showNearbyPets'>Show Nearby Pet Shops</a><a href='#' class='button' id='cancelModal'>Cancel</a></div>");
                    }
                    else {
                        $("#modalContent").append("<div class='buttons modalButtonsHolder'><a class='button primary nearby' href='#' id='showNearbyPets'>Show Nearby Pet Shops</a><a href='#' class='button primary tsk' data-taskid='" + taskID + "'>Mark As Done</a><a href='#' class='button' id='cancelModal'>Cancel</a></div>");
                    }
                }
                else {
                    if ($(this).hasClass(that.compTaskClass)) {
                        ...
                        $("#modalContent").append("<div class='buttons modalButtonsHolder'><a href='#' class='button primary tsk' data-taskid='" + taskID + "'>Mark As Done</a><a href='#' class='button' id='cancelModal'>Cancel</a></div>");
                    }
                }
                that.$modal.show();
            });
